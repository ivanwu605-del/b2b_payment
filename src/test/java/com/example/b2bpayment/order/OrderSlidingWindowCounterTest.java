...
/**
 * 滑动窗口订单支付占比 B2bPayment。
 * 运行前请确保本地 Redis 已启动：127.0.0.1:6379，database=0。
 *
 * mvn test -Dtest=OrderSlidingWindowCounterTest#slidingWindowPaymentRatioB2bPayment
 */
@SpringBootTest
class OrderSlidingWindowCounterTest {
    ...
    @Test
    void slidingWindowPaymentRatioB2bPayment() {
        ...
        System.out.println("========== 滑动窗口订单支付占比 B2bPayment ==========");
